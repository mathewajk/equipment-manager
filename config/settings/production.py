...
ALLOWED_HOSTS = env.list(
    "DJANGO_ALLOWED_HOSTS", default=["gltc-equipment-manager.com"]
)
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="EquipmentManager <noreply@gltc-equipment-manager.com>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    "DJANGO_EMAIL_SUBJECT_PREFIX", default="[EquipmentManager]"
)
